...
import tsys.utilities.Settings;

public class ChromedriverHandler {
//Todo: Add more details surrounding this class and it's use
    /**
     * This class is used to handle issues with chrome that occur when appium switches context
     */
    private void chromeDriverHandler()

    {
        String chromePort = ((Settings.ChromePort == null ? System.getProperty("chromePortNbr", "9515") : Settings.ChromePort));
        while(true)
        {
            try
            {
                String url = "http://127.0.0.1:" + chromePort +"/wd/hub/sessions";
