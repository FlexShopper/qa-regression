...
public class Wait {
     ...
     * @return
     */
    public static WebElement waitForVisib(WebElement element, int timeToWaitInSec) {
     ...
     * @return
     */
    public static WebElement waitForClickab(WebElement element, int timeout) {
...
//        String date = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));​
    ...
    public static void waitForPageRefreshed(WebElement element) {
        WebDriverWait wait = new WebDriverWait(driver, 10);
